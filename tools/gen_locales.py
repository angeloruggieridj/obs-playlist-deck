...
T = {
 "es-ES": ["Fuente multimedia","Lista de reproducción","Archivo de lista","Filtrar…",
  ...
  "Playlist Deck — Ajustes","Detectar duración de los medios (en segundo plano)","Restaurar la última lista al iniciar","Idioma","Ajustes guardados.","Automático (seguir OBS)", "archivo no encontrado"],
 ...
 "fr-FR": ["Source multimédia","Liste de lecture","Fichier de liste","Filtrer…",
  ...
  "Playlist Deck — Réglages","Détecter la durée des médias (en arrière-plan)","Restaurer la dernière liste au démarrage","Langue","Réglages enregistrés.","Auto (suivre OBS)", "fichier introuvable"],
 ...
 "de-DE": ["Medienquelle","Wiedergabeliste","Wiedergabelisten-Datei","Filtern…",
  ...
  "Playlist Deck — Einstellungen","Mediendauer ermitteln (im Hintergrund)","Letzte Wiedergabeliste beim Start wiederherstellen","Sprache","Einstellungen gespeichert.","Automatisch (OBS folgen)", "Datei nicht gefunden"],
 ...
 "pt-BR": ["Fonte de mídia","Playlist","Arquivo de playlist","Filtrar…",
  ...
  "Playlist Deck — Configurações","Detectar duração das mídias (em segundo plano)","Restaurar a última playlist ao iniciar","Idioma","Configurações salvas.","Automático (seguir o OBS)", "arquivo não encontrado"],
 ...
 "ru-RU": ["Медиаисточник","Плейлист","Файл плейлиста","Фильтр…",
  ...
  "Playlist Deck — Настройки","Определять длительность медиа (в фоне)","Восстанавливать последний плейлист при запуске","Язык","Настройки сохранены.","Авто (как в OBS)", "файл не найден"],
 ...
 "zh-CN": ["媒体源","播放列表","播放列表文件","筛选…",
  ...
  "未加载播放列表","已加载：%1",
  "Playlist Deck — 设置","在后台检测媒体时长","启动时恢复上次的播放列表","语言","设置已保存。","自动（跟随 OBS）", "未找到文件"],
 ...
 "ja-JP": ["メディアソース","プレイリスト","プレイリストファイル","フィルター…",
  ...
  "Playlist Deck — 設定","メディアの長さをバックグラウンドで取得","起動時に前回のプレイリストを復元","言語","設定を保存しました。","自動（OBSに従う）", "ファイルが見つかりません"],
 ...
 "ko-KR": ["미디어 소스","재생목록","재생목록 파일","필터…",
  ...
  "재생목록 없음","불러옴: %1",
  "Playlist Deck — 설정","미디어 길이 백그라운드 감지","시작 시 마지막 재생목록 복원","언어","설정이 저장되었습니다.","자동 (OBS 따름)", "파일을 찾을 수 없음"],
}
